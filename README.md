...
---
i do enjoy low level language's power and control,and High level languages ease of use as such you might see my c++ code written in c style c++.
  ...
  - Canvas : a CPU Rasterization single header, it mimicks the normal drawing pipe line via lambdas and per draw function context object.
  ...
  - Toxic Speech detection and criticism reinterpretation : Goal is to help online platforms to hide toxic speech and reinterpret useful but foul mouthed criticism into neutral clear criticism.
